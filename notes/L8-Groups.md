...
- __Principal component analysis__ allows us to project hight dimensional data into a lower dimensional space
	...
	+ Unfortunately this potentially has problems if the items in the data are not distributed such that the largest axes of variance are good discriminators of similarity

#### Multidimensional Scaling
- __Multidimensional Scaling (MDS)__ is another approach
	+ 
