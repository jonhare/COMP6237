...
import uk.ac.soton.ecs.comp6237.l2.ItemSpaceSlide;
import uk.ac.soton.ecs.comp6237.l2.UserSpaceSlide;
...
@Lecture(
		title = "L2: Making Recommendations",
		handoutsURL = "https://github.com/jonhare/COMP6237/blob/master/notes/Recommendation.pdf",
		slidesURL = "http://comp6237.ecs.soton.ac.uk/lectures/pdf/Recommendation.pdf")
...
public class Lecture2 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i <= 56; i++) {
			slides.add(new PictureSlide(Lecture2.class.getResource(String.format("%03d.jpeg", i))));
		}
