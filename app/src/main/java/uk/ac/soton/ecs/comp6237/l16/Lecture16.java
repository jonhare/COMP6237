...
@Lecture(
		title = "L16: Mining Events from Multimedia Streams",
...
public class Lecture16 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i <= 55; i++) {
			slides.add(new PictureSlide(Lecture16.class.getResource(String.format("%03d.jpeg", i))));
		}

		slides.set(23, new AudioVideoSlide(Lecture16.class.getResource("twitter-pulse-ui.mpg"), EndAction.STOP_AT_END));
