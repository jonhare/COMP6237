...
import uk.ac.soton.ecs.comp6237.l6.Lecture6;
...
@Lecture(
		title = "L6: Searching and Ranking",
...
public class Lecture6 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i <= 49; i++) {
			slides.add(new PictureSlide(Lecture6.class.getResource(String.format("%03d.jpeg", i))));
		}
