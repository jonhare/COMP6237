...
public class Lecture6 {
	public static void main(String[] args) throws IOException {
		...
		slides.set(36,
				new GroovyREPLConsoleSlide(JSplitPane.HORIZONTAL_SPLIT, Lecture6.class.getResource("../UserSim.groovy"))); // user-user
		// sim
		slides.set(39,
				new GroovyREPLConsoleSlide(JSplitPane.HORIZONTAL_SPLIT, Lecture6.class.getResource("../MovieSim.groovy"))); // user
		// based rec

		slides.set(42, new UserSpaceSlide()); // item-item sim

		slides.set(45, new UserSpaceSlide()); // item-item precomp
		slides.set(47, new UserSpaceSlide()); // item-based rec
