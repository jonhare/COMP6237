...
Required files: brief.pdf  [Brief Template](https://github.com/jonhare/COMP6237/blob/gh-pages/cw/brief_template.tex)
...
* **Project Brief.** Teams must submit a short (1 side A4 max) project brief to ECS handin by **Friday 18th February**. In addition to describing the proposed project, the brief must include the names and email addresses of all the team members. Template available here
